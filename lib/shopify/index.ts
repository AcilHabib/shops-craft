...
export async function getCollectionProducts({
  ...
  const collectionHandle = collections.find((c) => c.title === collection);
  ...
  const collections = [
    {
      ...
      // Add any other required properties from Collection type here if needed
    },
